...
static void list_print_status(status);
static plist list_new(void);
static plist list_copy(plist);
static pnode node_new(val value);
static void list_init(plist l);
static void list_del(plist *l);

// getting an item from a list
static status list_get_val(plist l, size_t index, val *value);
static status list_get_ptr(plist l, size_t index, val **value);
static status list_get_node(plist l, size_t index, pnode *n);
static status list_swap(plist l, size_t index1, size_t index2);
static status list_reverse(plist l);

// display the list
static void list_print(plist l, const char* val_fmt);
static void list_print_reverse(plist l, const char* val_fmt);

// iterating the list
static pnode list_iter(plist l);
static bool list_iter_next(pnode *n);
static void list_map(callback_t callback, plist l);

// adding elements to a list
static status list_append(plist l, val value);
static status list_prepend(plist l, val value);
static status list_insert_at(plist l, size_t index, val Value);

// removing elements from a list
static status list_remove_back(plist l);
static status list_remove_font(plist l);
static status list_remove_at(plist l, size_t index);
